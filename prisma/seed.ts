...
async function main() {
  ...
  await prisma.heroContent.upsert({
    ...
    create: {
      ...
      description:
        "Join us in our mission to create positive change in communities worldwide. Together, we can build a better future for everyone.",
  ...
  await prisma.aboutContent.upsert({
    ...
    create: {
      ...
      description:
        "IDFE Charity is dedicated to improving lives and building stronger communities through sustainable development programs.",
      mission:
      ...
      values: [
        {
          title: "Integrity",
          description:
            "We operate with transparency and honesty in all our activities.",
        },
        {
          title: "Compassion",
          description:
        ...
        },
        {
          ...
          description:
            "We focus on long-term solutions that benefit communities.",
        },
      ],
  ...
  const programs = [
    ...
    },
    {
      ...
      description:
        "Improving healthcare accessibility and quality in remote areas.",
      category: "Healthcare",
  ...
  await prisma.contactInfo.upsert({
    ...
    create: {
      ...
      mapUrl:
        "https://maps.google.com/embed?pb=!1m18!1m12!1m3!1d3024.123!2d-74.006!3d40.713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1",
      isActive: true,
    },
  });
  ...
  await prisma.cTAContent.upsert({
    ...
    create: {
      ...
      description:
        "Join our mission to create positive change in communities worldwide. Your support can help us reach more people and create lasting impact.",
  ...
  await prisma.footerContent.upsert({
    ...
    create: {
      id: "footer-1",
      description:
        "IDFE Charity is committed to creating positive change through sustainable development programs and community empowerment initiatives.",
      quickLinks: [
      ...
      socialLinks: [
        {
          platform: "Facebook",
          url: "https://facebook.com/idfecharity",
          icon: "facebook",
        },
        {
          platform: "Twitter",
          url: "https://twitter.com/idfecharity",
          icon: "twitter",
        },
        {
          platform: "Instagram",
          url: "https://instagram.com/idfecharity",
          icon: "instagram",
        },
        {
          platform: "LinkedIn",
          url: "https://linkedin.com/company/idfecharity",
          icon: "linkedin",
        },
      ],
