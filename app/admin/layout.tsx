...
const navigation = [
  ...
  { name: 'About Section', href: '/admin/about', icon: 'ℹ️' },
  { name: 'Programs', href: '/admin/programs', icon: '📋' },
  { name: 'Impact Stats', href: '/admin/impact', icon: '📈' },
  { name: 'Contact Info', href: '/admin/contact', icon: '📞' },
  { name: 'CTA Section', href: '/admin/cta', icon: '🎯' },
  { name: 'Footer', href: '/admin/footer', icon: '⬇️' },
];
